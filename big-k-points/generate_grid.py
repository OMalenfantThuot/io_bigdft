...
if gridx % 2 == 0:
    coordx = np.linspace(-0.5 + 1.0 / gridx, 0.5, num=gridx)
    coordz = np.linspace(-0.5 + 1.0 / gridz, 0.5, num=gridz)
else:
    coordx = np.linspace(-0.5 + 1.0 / (2 * gridx), 0.5 - 1.0 / (2 * gridx), num=gridx)
    coordz = np.linspace(-0.5 + 1.0 / (2 * gridz), 0.5 - 1.0 / (2 * gridz), num=gridz)
