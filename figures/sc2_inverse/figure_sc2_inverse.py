...
ab2 = AnnotationBbox(imagebox2, [distances1[max1]-0.02, reaction1[max1]+0.01],
                    ...
                    arrowprops=dict(arrowstyle = "->", linewidth=3))
ab3 = AnnotationBbox(imagebox3, [distances1[-1], reaction1[-1]+0.02],
                    xybox = [0.63 * distances2[-1], 4.1],
                    arrowprops=dict(arrowstyle = "->", linewidth=3))
ab4 = AnnotationBbox(imagebox4, [distances2[max2]+0.02, reaction2[max2]+0.01],
                    xybox = [0.94 * distances2[-1], 4.1],
                    arrowprops=dict(arrowstyle = "->", linewidth=3))
ab5 = AnnotationBbox(imagebox5, [distances2[-1]-0.01, reaction2[-1]-0.02],
...
#Show or save figure
#plt.show()
plt.savefig('sc2_inverse', dpi = 250)
