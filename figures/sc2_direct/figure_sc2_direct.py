...
ax.plot([distances1[min1], distances1[max1]], [reaction1[min1], reaction1[min1]], '--k')
...
ax.arrow(distances1[max1], reaction1[-1], 0, -reaction1[-1]+reaction1[min1]+0.01, width=0.005, facecolor='k',
        length_includes_head=True, head_width=0.025, head_length = 0.1)
...
ax.text(distances1[max1] + 0.05, reaction1[max1]/2, '{:4.2f} eV'.format(reaction1[max1]-reaction1[min1]), fontsize = 20)
...
#Show or save figure
#plt.show()
plt.savefig('sc2_direct', dpi = 300)
